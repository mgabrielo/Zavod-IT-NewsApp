...
import { getAllNewsFailure, getAllNewsStart, getAllNewsSuccess, setNewsTotal, setNewsTotalTags, setTotalDisLikes, setTotalLikes } from "../redux/news/newsSlice";

export const newsAction = () => {
    const { news, newsLoading, totalTags, totalLikes, totalDisLikes } = useSelector((state) => state.news);
    ...
    const fetchAllNews = async () => {
        ...
        try {
            ...
            if (res.data?.news) {
                ...
                if (res.data?.totalNews && res.data?.totalTags && res.data?.totalLikes && res.data?.totalDislikes) {
    ...
    return { fetchAllNews, news, addNews, deleteNews, newsLoading, totalTags, totalLikes, totalDisLikes };
};